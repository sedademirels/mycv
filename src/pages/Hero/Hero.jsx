        ...
        <div id='home' className="hero-container" >
            ...
            <div className="hero-content">
                <div className="text-content">
                    ...
                    <p className="description">Is is a long established fact that a reader will be distracted by the readable content of page when at its layout. türkçe çevir
                    </p>
